...
mod water;
pub mod worldtwotextureblend;
mod worldvertextransition;

use crate::material::worldtwotextureblend::WorldTwoTextureblendMaterial;
...
pub enum Material {
    ...
    Patch(PatchMaterial),
    WorldTwoTextureblend(WorldTwoTextureblendMaterial),
}
...
impl Material {
    ...
    pub fn base_texture(&self) -> Option<&str> {
        match self {
            ...
            Material::WorldTwoTextureblend(mat) => Some(&mat.base_texture),
            _ => None,
        }
    }
